  ...
  computed:{
    border(){
      if(this.modelValue==false){
        ...
        return "border: 4px red solid;"
      }
      //return (this.modelValue) ?  "border: 4px red solid;" : ""
    }
  },


  template:`
  <img :src="src" @click="$emit('update:modelValue',!modelValue)" :style="border">
  `
